/// This file was taken from sharkdp amazing "fd" tool: https://github.com/sharkdp/fd
///
/// Make sure to cite him if you use this code.
...
impl SizeFilter {
    pub fn from_string(s: &str) -> anyhow::Result<Self> {
        SizeFilter::parse_opt(s)
            .ok_or_else(|| anyhow!("'{}' is not a valid size constraint. See 'fss --help'.", s))
    }
